 ...
 */
// util.initSwipePagination = function () {
...
//
//         const outDir = direction;
//         const inDir = direction === 'left' ? 'right' : 'left';
//
//         // Animate old list out
//         resetAnimationClasses();
//         util.listContainer.classList.add(`slide-out-${outDir}`);
//
//         // Wait a bit, then trigger page load
//         await util.delay(animDuration * 0.8);
//         targetLink.click();
//
//         // Wait for content load via event instead of setInterval
//         const handleLoaded = () => {
...
//             resetAnimationClasses();
//             util.listContainer.classList.add(`slide-in-${inDir}`);
//             setTimeout(() => resetAnimationClasses(), animDuration);
//         }
//     });
// };
